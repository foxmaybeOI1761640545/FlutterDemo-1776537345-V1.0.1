---
name: openai-flutter-github-actions-strict-local-no-install
description: Guide for remote-first Flutter development where local machine is editing+Git only and GitHub Actions handles build, artifact packaging, and release. Use when users ask for Flutter CI/CD workflow YAML, GitHub Release/Pages automation, or avoiding local Flutter/Dart/toolchain installation.
---
